...
function Tentang() {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto flex flex-row max-xmd:flex-col-reverse px-6 py-12 gap-6 relative mt-[10px]">
      ...
      {/* Foto sebelah kiri */}
      <div className="absolute left-0 -translate-x-1/5 ml-23 max-sm:ml-7 max-xmd:ml-7 mt-32 max-sm:mt-0 max-xmd:mt-0">
        <img
          src={Miesumpit}
          alt="Promo Mie"
      ...
      <div className="ml-[351px] max-sm:ml-[50px] max-xmd:ml-[205px] max-w-3xl">
          <p className="text-black font-boogaloo text-[50px] max-sm:text-[20px] max-xmd:text-[40px] max-md-text-[20px] text-left">
