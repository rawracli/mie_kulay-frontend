  ...
  return (
    ...
    <div className="max-w-6xl mx-auto flex flex-col-reverse sm:flex-row px-6 py-12 gap-6 relat mt-[10px]">
      ...
      <div className="flex-1 relative">
        <h3 className="text-[49px] font-boogaloo relative z-10  max-sm:text-[40px] mt-[43px] max-sm:text-center">
          Cerita di Balik Kedai Mie Kulay
        </h3>
        <p className="text-black leading-relaxed text-[24px] max-sm:text-[16px] max-sm:text-center mt-[34px] font-baloo-2">
      ...
      <div className="flex-1 relative h-[500px] flex items-center justify-center">
        ...
        <img
          src={Toko}
          alt="Kedai Atas"
          className="rounded-lg object-cover w-[501px] max-sm:w-[266px] h-[356px] max-sm:h-[188px] md:absolute  top-0 right-0 shadow-lg ml-[13px]"
        />
        {/* Gambar 2 */}
        <img
          src={Toko1}
