  ...
  return (
    <div className="flex max-md:flex-col h-screen">
      ...
      <div className="flex flex-1 max-sm:items-start items-center justify-center bg-white">
        ...
        <form onSubmit={handleSubmit} className="shadow-[0px_0px_9px_-2px_rgba(0,0,0,0.75)] p-10 max-sm:p-0 rounded-md lg:w-[503px] lg:h-[547px] max-sm:w-[323px] max-sm:h-[405px] max-sm:mt-[107px] max-sm:ml-[33px] max-sm:mr-[33px] max-sm:z-10 max-md:z-10 bg-white">
          ...
          type="submit"
              disabled={loading}
              >
            <h3 className="text-center-2xl font-semibold">{loading ? "Loading..." : "Login"}</h3>
          </button>
        </form>
      </div>
