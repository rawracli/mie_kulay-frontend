    ...
    <div className="bg-[#EDF0F2] flex flex-col min-h-[calc(100vh-92px)] pt-[4px] pl-[13px] pr-[8px] pb-[8px] font-sans text-gray-800">
      <div className="grid grid-cols-[381px_1fr] gap-x-3 overflow-hidden mb-[9px] max-h-[141px]">
        <div className="bg-white flex flex-col shadow-[0px_2px_6px_rgba(156,156,156,0.25)]">
          ...
          <div className="flex items-center justify-center h-full">
            <p className="text-[36px] font-semibold pb-[12px]">
              {formattedDate}
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 grid grid-cols-[1fr_198px] overflow-hidden">
        ...
        <div className="flex flex-col justify-between mx-[14px]">
          <button
            ...
            className="bg-[#44962D] hover:bg-[#3E8C29] active:bg-[#3A7D27] h-[43px] rounded-[10px] flex gap-[7.94px] items-center justify-center cursor-pointer"
          >
      ...
      <div className="mt-[7px] h-[105px] bg-white shadow-[0px_2px_6px_rgba(156,156,156,0.25)] p-[10px] flex justify-end items-center">
        ...
        <button
          ...
          className="bg-[#FFB300] hover:bg-[#F1A900] active:bg-[#D59501] text-white px-6 py-4 ml-[10px] h-[66px] gap-[14px] cursor-pointer flex items-center w-[174px] rounded-[10px] text-xl font-semibold"
        >
