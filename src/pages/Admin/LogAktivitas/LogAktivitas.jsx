...
function LogAktivitas() {
  ...
  return (
        <div className="bg-gray-200 min-h-screen w-full flex justify-center py-6">
        ...
        <div className="flex items-center gap-4 mb-4">
          <label className="flex items-center gap-2">
            <select
              ...
              className="bg-gray-100 border p-1 rounded-[2px] w-[47px] h-[32px]"
            >
          ...
          <select
            ...
            className="bg-gray-100 border p-1 rounded-[5px] w-[164px] h-[35px] ml-40"
          >
          ...
          <input
            ...
            className="bg-gray-100 border pl-5 pr-3 rounded-[2px] w-[234px] h-[32px] "
          />
        </div>
          ...
          <table className="w-full border border-gray-300">
            <thead>
              <tr className="bg-yellow-400 text-center ">
                <th className="p-2 border h-[47px]">User</th>
