...
function Kontak() {
  ...
  return (
    ...
    <div className="w-full min-h-screen bg-white pt-[29px] pb-[37px] pl-[34px] pr-[40px]">
      {/* Content */}
      <div className="max-w mx-auto flex flex-col md:flex-row gap-[22px]">
        {/* Form (lebih sempit) */}
        <div className="animate__animated animate__slideInLeft flex-2 py-[27px] rounded-[10px] h-[436px] shadow-[0px_2px_6px_rgba(156,156,156,0.7)]">
          <h2 className="text-[32px] font-bold mb-4 font-boogaloo ml-[47px] mr-[45px]">
          ...
          >
            <div>
              <label className="block text-sm font-semibold mb-1 py-1">
                Nama
              </label>
              <input
                type="text"
        ...
        <div className="animate__animated animate__slideInRight flex-[1.5] h-[436px] pt-[26px]  rounded-[10px] shadow-[0px_2px_6px_rgba(156,156,156,0.7)] ">
          <h2 className="text-[32px] font-bold mb-2  font-boogaloo ml-[38px] mr-[159px]">
            Informasi Kontak
          </h2>
          <p className="text-[#737373] font-baloo-2  mb-4 ml-[38px]">
            Berikut ini adalah kontak kami yang bisa dihubungi
          </p>
          <hr className="mx-[30px]"></hr>
          <ul className="space-y-9 ml-[43px] mr-[31px] py-5">
            <li className="flex items-center gap-3 font-bold pt-7">
              <svg
                width="24"
                height="25"
                viewBox="0 0 24 25"
      ...
      <div className="max-w mx-auto mt-[16px] md:flex-row gap-6 h-full animate_animated animate_FadeIn">
        {/* Form (lebih sempit) */}
        <iframe
